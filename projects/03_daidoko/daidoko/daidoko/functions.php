...
if ( ! function_exists( 'daidoko_setup' ) ) :
	...
	function daidoko_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'daidoko_custom_background_args',
				array(
...
function daidoko_scripts() {
	wp_enqueue_style( 'daidoko-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'daidoko-style', 'rtl', 'replace' );

	wp_enqueue_script( 'daidoko-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'daidoko-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
